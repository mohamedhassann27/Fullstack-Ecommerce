...
<section className="py-15! md:px-12! relative mb-6">
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-2">
        ...
        <div className="pro-detail w-full flex flex-col justify-center order-last lg:order-0 max-lg:max-w-152 max-lg:mx-auto">
            <p className="font-medium text-lg text-theme mb-4">Products &nbsp; / &nbsp; {productDetails?.category}</p>
            <h2 className="mb-2 font-manrope font-bold text-3xl leading-10 text-gray-900 dark:text-white">{productDetails?.title}
            </h2>
            ...
            <div className="flex items-center gap-2">
                ...
                <span className="pl-1 font-normal leading-7 text-gray-500 ">({productDetails?.reviews}review)</span>
            </div>
            ...
            <p className="font-medium text-lg leading-8 text-gray-900 mb-4 dark:text-white">Bag Color</p>
            <div className="text">
                <div className="flex items-center justify-start gap-3 md:gap-6 relative mb-6 ">
                <button data-ui="checked active" className="p-2.5 border border-gray-200 rounded-full transition-all duration-300 hover:border-emerald-500 :border-emerald-500">
        ...
        >
            {productDetails?.images.map(img=>(
                <SwiperSlide><img src={img} loading='lazy' alt="product image" className="object-cover w-full h-120 mx-auto rounded-sm" /></SwiperSlide>
            ))}
        </Swiper>
    </div>
    </div>
