...
import { LogOut, Settings, User, ShoppingBag, Star, LayoutDashboard } from "lucide-react";
        ...
        <DropdownMenu {...props}>
            ...
            <DropdownMenuLabel className="font-normal">
                ...
                <div className="flex flex-col space-y-1">
                    <p className="text-sm leading-none font-medium">{userData?.user_metadata?.userName}</p>
            ...
            {userData?.user_metadata?.role=='admin' &&
                <DropdownMenuItem>
                    <Link to='/dashboard' className="flex gap-1 hover:text-theme items-center">
                        <LayoutDashboard />
                        Dashboard
                    </Link>
                </DropdownMenuItem>
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem onClick={logoutHandler} variant="destructive" className="cursor-pointer">
                <LogOut />
                Log out
            </DropdownMenuItem>
            </DropdownMenuContent>
